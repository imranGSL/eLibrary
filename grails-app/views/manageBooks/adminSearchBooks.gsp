        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-9">
                ...
                <select id="categoryName" name="categoryName" class="select2" data-placeholder="Click to Choose...">
                    ...
                    <g:each status="i" in="${myobj}" var="catagory">
...
<div class="content scaffold-create" role="main">
    ...
    <g:each in="${myobj1}">
        <table border="0" class="table table-bordered">
            ...
            <tr>
                <td>
                    <g:form controller="manageBooks" action="delete"><g:textField name="id" hidden="" value="${it.id}"/>
                        <g:submitButton name="submit" value="Delete" class="btn btn-danger"/>
                    </g:form>
                </td>
